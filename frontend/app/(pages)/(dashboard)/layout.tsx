...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-theme-base">
      <ImpersonationBanner />
      <header
        className={`lg:hidden fixed left-0 right-0 z-30 bg-theme-sidebar border-b border-theme-border px-4 py-3 flex items-center gap-3 ${isImpersonating ? "top-6" : "top-0"}`}
      >
        <button
