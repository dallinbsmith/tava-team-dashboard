          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {paginatedMembers.map((member) => (
              ...
              >
                ...
                {/* Squad badges - clickable to navigate to that squad */}
                  ...
                  <div className="flex flex-wrap gap-1 mt-2 pt-2 border-t border-theme-border">
                    {member.squads.map((squad) => (
                      <Link
                        ...
                        className="inline-flex items-center px-2 py-0.5 text-xs font-medium bg-primary-900/30 text-primary-300 border border-primary-500/30 hover:bg-primary-900/50 hover:border-primary-500/50 transition-colors"
