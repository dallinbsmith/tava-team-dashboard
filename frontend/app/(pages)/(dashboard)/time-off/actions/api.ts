...
export const getMyTimeOffRequests = async (status?: TimeOffStatus): Promise<TimeOffRequest[]> => {
...
export const getTimeOffRequest = async (id: number): Promise<TimeOffRequest> => {
