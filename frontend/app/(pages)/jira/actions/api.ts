...
// Tasks
export const getMyJiraTasks = async (maxResults: number = 50): Promise<JiraIssue[]> => {
...
export const getTeamJiraTasks = async (maxPerUser: number = 20): Promise<TeamTask[]> => {
...
// Epics
export const getJiraEpics = async (maxResults: number = 100): Promise<JiraIssue[]> => {
...
// OAuth
export const getJiraOAuthAuthorizeURL = async (): Promise<JiraOAuthAuthorizeResponse> => {
