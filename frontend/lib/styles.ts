...
export const selectTriggerStyles = `${inputBase} ${inputFocus} text-left flex items-center justify-between`;

// Button styles
export const buttonPrimary = `${buttonBase} bg-primary-500 text-white hover:bg-primary-600`;

export const buttonSecondary = `${buttonBase} border border-theme-border text-theme-text hover:bg-theme-elevated`;
...
export const dropdownItemButton =
  "w-full flex items-center gap-2 px-4 py-2.5 text-sm text-theme-text hover:bg-theme-elevated transition-colors";
...
export const tableHeader =
  "text-left px-4 py-3 text-xs font-semibold text-theme-text-muted uppercase tracking-wider";
export const tableHeaderSortable = `${tableHeader} cursor-pointer hover:bg-theme-surface/50 transition-colors`;

// Widget container
export const widgetContainer =
  "bg-theme-surface border border-theme-border overflow-hidden flex flex-col";
export const widgetHeader =
  "px-6 py-4 border-b border-theme-border flex items-center justify-between";
export const widgetFooter =
  "px-6 py-3 bg-theme-elevated border-t border-theme-border mt-auto";
